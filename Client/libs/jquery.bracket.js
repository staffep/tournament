...
!function (a) {
    ...
    function g(b, c, d) {
        var e = d || c
            , g = e.winner()
            , h = e.loser();
        g && h && (g.name.isEmpty() || f(g.seed.get(), "highlightWinner", b).highlight(),
                h.name.isEmpty() || f(h.seed.get(), "highlightLoser", b).highlight()),
            b.find(".team").mouseover(function () {
    ...
    function h(b, c, d) {
        ...
        e.val(c),
            ...
            e.keydown(function (a) {
                ...
                9 !== b && 13 !== b && 27 !== b || (a.preventDefault(),
                    d(e.val(), 27 !== b))
            })
    }
    function i(a, b, c, d) {
    ...
    function j(a) {
        ...
        return d.append('<div class="bubble">2nd</div>'),
            !0
    }
    function k(a) {
        var b = a.el
        ...
        var d = b.find(".team.lose");
        return d.append('<div class="bubble fourth">4th</div>'),
            !0
    }
        ...
        for (var f, g = Math.log(2 * b.length) / Math.log(2), h = b.length, i = 0; i < g; i += 1) {
            ...
            for (var l = 0; l < h; l += 1) {
                ...
                if (i === g - 1 && c || i === g - 1 && e) {
                    ...
                    f.addMatch(m, u.empty())
            }
            h /= 2
        }
        if (c && (a.final().setConnectorCb(u.empty()),
            b.length > 1 && !d.skipConsolationRound)) {
        ...
        for (var f = Math.log(2 * c) / Math.log(2) - 1, g = c / 2, h = 0; h < f; h += 1) {
            for (var i = d && h === f - 1 ? 1 : 2, j = 0; j < i; j += 1)
                for (var l = b.addRound(u.empty()), m = 0; m < g; m += 1) {
                    ...
                    if (p.setAlignCb(D(p.el.find(".teamContainer"), p)),
                        o)
                        p.setConnectorCb(u.empty());
                    else if (h < f - 1 || j < 1) {
    ...
    function n(a, b, c, d, e, f) {
        ...
        if (h.setAlignCb(function (a) {
                ...
                d.skipConsolationRound || (e /= 2),
                    h.el.css("height", e + "px");
            ...
            l.setAlignCb(function (a) {
                ...
                h.setConnectorCb(u.empty()),
                l.setConnectorCb(u.empty())
        }
    ...
    function o(b, c, d, e) {
        ...
        j.css("height", f),
            j.css("width", h + "px"),
            j.css(e, -h - 2 + "px"),
            g >= 0 ? j.css("top", g - 1 + "px") : j.css("bottom", -g - 1 + "px"),
            i ? j.css("border-bottom", "none") : j.css("border-top", "none");
        var k = a('<div class="connector"></div>').appendTo(j);
        return k.css("width", h + "px"),
            k.css(e, -h + "px"),
            i ? k.css("bottom", "0px") : k.css("top", "0px"),
            j
    }
    function p(a, b, c, d, e) {
        if (b)
            return Math.log(2 * a) / Math.log(2);
        if (c)
            return Math.max(2, 2 * (Math.log(2 * a) / Math.log(2) - 1) - 1);
            ...
            c.results = c.results.map(function (a) {
                return a.map(function (a) {
                    return a.map(function (a) {
                        ...
                        return void 0 !== a.userData && b.push(a.userData),
                            b
                    })
                })
            }),
    ...
    function r(c, d, e, f, g, h, i, j, k, l) {
        ...
        if (i.decorator.render(s, e.name.toNull(), p, q),
            e.seed.forEach(function (a) {
                r.attr("data-teamid", a)
            }),
            e.name.isEmpty() ? r.addClass("na") : d.winner().name === e.name ? r.addClass("win") : d.loser().name === e.name && r.addClass("lose"),
            r.append(n),
            (!e.name.isEmpty() || e.name.isEmpty() && 0 === c && h) && "function" == typeof i.save && (i.disableTeamEdit || (s.addClass("editable"),
                    s.click(function () {
                        function b() {
                            function f(f, g) {
                                var h = e.seed.get();
                                i.init.teams[~~(h / 2)][h % 2] = u.of(f || null),
                                    l(!0),
                                    d.click(b);
                            ...
                            d.unbind(),
                                i.decorator.edit(d, e.name.toNull(), f)
                        }
                        var d = a(this);
                        b()
                    })),
                ...
                n.click(function () {
                    function c() {
                        ...
                        g.val(f),
                            ...
                            g.blur(function () {
                                var a = g.val();
                                a && b(a) || b(e.score) ? a && b(a) || !b(e.score) || (a = e.score) : a = "0",
                                    d.html(a),
                                    b(a) && (e.score = v.of(parseInt(a, 10)),
                                        l(!0)),
                                    d.click(c)
                            })
                    }
    ...
    function s(b, c, d) {
        ...
        if (f.click(function () {
                for (var a = c.teams.length, b = 0; b < a; b += 1)
                    c.teams.push([u.empty(), u.empty()]);
                return K(d)
            }),
            ...
            g.click(function () {
                if (c.teams.length > 1)
                    return c.teams = c.teams.slice(0, c.teams.length / 2),
                        K(d)
            })
        }
        if (1 === c.results.length && c.teams.length > 1) {
            ...
            h.click(function () {
                if (c.teams.length > 1 && c.results.length < 3)
                    return c.results.push([], []),
                        K(d)
            })
        } else if (3 === c.results.length && c.teams.length > 1) {
            var h = a('<span class="singleElimination">se</span>').appendTo(e);
            h.click(function () {
                if (3 === c.results.length)
                    return c.results = c.results.slice(0, 1),
                        K(d)
            })
        }
    }
        ...
        return __extends(b, a),
            b.of = function (a) {
                var b = typeof a
                    , c = "number";
                if (null !== a && b !== c)
                    throw new Error("Invalid score format, expected " + c + ", got " + b);
                return u.of(a)
            }
            ,
            b.empty = function () {
    ...
    var x = function () {
        ...
        , z = function () {
            ...
            return a.teamsInResultOrder = function (a) {
                    var b = a.a.name.isEmpty()
                        , c = a.b.name.isEmpty();
                    if (c && !b)
                        return a.b.emptyBranch() === t.BYE ? [a.a, a.b] : [];
                    if (b && !c)
                        return a.a.emptyBranch() === t.BYE ? [a.b, a.a] : [];
                    if (!a.a.score.isEmpty() && !a.b.score.isEmpty()) {
                        if (a.a.score.get() > a.b.score.get())
                            return [a.a, a.b];
                        if (a.a.score.get() < a.b.score.get())
                            return [a.b, a.a]
                    }
        ...
        , B = function (a, b) {
            return function (c) {
                c.css("top", ""),
                    ...
                    b ? c.css("top", a.el.height() / 2 - c.height() / 2 + "px") : c.css("bottom", -c.height() / 2 + "px")
            }
        }
        ...
        , E = function () {
            function b(b, c, d, e, f, g, h, i) {
                this.bracket = b,
                    ...
                    this.roundCon = a('<div class="round" style="width: ' + this.containerWidth + "px; margin-right: " + this.opts.roundMargin + 'px"/>'),
                    this.matches = []
            }
            return Object.defineProperty(b.prototype, "el", {
                ...
                b.prototype.render = function () {
                    this.roundCon.empty(),
                        (this.doRenderCb.isEmpty() || this.doRenderCb.get()()) && (this.roundCon.appendTo(this.bracket.el),
        ...
        , F = function () {
            ...
            return Object.defineProperty(a.prototype, "el", {
                ...
                a.prototype.render = function () {
                    ...
                    for (var a = 0; a < this.rounds.length; a += 1)
                        this.rounds[a].render()
                }
                ,
        ...
        , H = function () {
            function c(c, d, e, f, g, h, i, j, k, l) {
                if (this.round = c,
                    ...
                    this.topCon = k,
                    this.renderAll = l,
                    this.connectorCb = u.empty(),
                    this.matchCon = a('<div class="match"></div>'),
                    this.teamCon = a('<div class="teamContainer"></div>'),
                    this.alignCb = null,
                    this.matchUserData = f.isEmpty() ? void 0 : f.get().userData,
                    !i.save) {
                ...
                d.a.name = d.a.source().name,
                    d.b.name = d.b.source().name,
                    d.a.score = f.map(function (a) {
                        return a.first.toNull()
                    }),
                    d.b.score = f.map(function (a) {
                        return a.second.toNull()
                    }),
                    d.a.name && d.b.name || !b(d.a.score) && !b(d.b.score) || (console.log("ERROR IN SCORE DATA: " + d.a.source().name + ": " + d.a.score + ", " + d.b.source().name + ": " + d.b.score),
                        d.a.score = d.b.score = v.empty())
            }
            return Object.defineProperty(c.prototype, "el", {
                ...
                c.prototype.render = function () {
                    ...
                    this.teamCon.append(r(this.round.roundNumber, this.match, this.match.a, this.match.b, c, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll)),
                        this.teamCon.append(r(this.round.roundNumber, this.match, this.match.b, this.match.a, c, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll)),
                ...
                c.prototype.results = function () {
                    ...
                    return a && (this.match.a.score = this.match.b.score = v.empty()),
                        new w(this.match.a.score, this.match.b.score, this.matchUserData)
                }
                ,
                c
        }()
        ...
        , K = function (b) {
            function c() {
                ...
                b.disableToolbar ? r.css("width", a * (b.teamWidth + b.scoreWidth + b.roundMargin) + 10) : r.css("width", a * (b.teamWidth + b.scoreWidth + b.roundMargin) + 40),
                    k && j.teams.length <= 2 && !b.skipConsolationRound && r.css("height", o + 40)
            }
            function d(a) {
                i.reset(),
                    e.render(),
                    f && f.render(),
                    h && !b.skipGrandFinalComeback && h.render(),
                    b.disableHighlight || g(r, e, h),
                    a && (j.results[0] = e.results(),
                        f && (j.results[1] = f.results()),
                        h && !b.skipGrandFinalComeback && (j.results[2] = h.results()),
                        c(),
                        b.save && b.save(q(j), b.userData))
            }
            var e, f, h, i = new G, j = b.init, k = j.results.length <= 1, o = 45 * j.teams.length + j.teams.length * b.matchMargin, r = a('<div class="jQBracket ' + b.dir + '"></div>').appendTo(b.el.empty());
            b.skipSecondaryFinal && k && a.error("skipSecondaryFinal setting is viable only in double elimination mode"),
                b.disableToolbar || s(r, j, b);
            var t, v, w;
            k ? v = a('<div class="bracket"></div>').appendTo(r) : (b.skipGrandFinalComeback || (t = a('<div class="finals"></div>').appendTo(r)),
                    v = a('<div class="bracket"></div>').appendTo(r),
                    w = a('<div class="loserBracket"></div>').appendTo(r)),
                v.css("height", o),
                w && w.css("height", v.height() / 2),
                c();
            var x = function (a, b, c, e, f, g, h) {
                return new H(a, b, c, e, f, g, h, i, r, d)
            };
            return e = new F(v, u.of(j.results[0] || null), x, !0, b),
                k || (f = new F(w, u.of(j.results[1] || null), x, !1, b),
                    b.skipGrandFinalComeback || (h = new F(t, u.of(j.results[2] || null), x, !1, b))),
                l(e, j.teams, k, b, b.skipGrandFinalComeback && !k),
                k || (m(e, f, j.teams.length, b.skipGrandFinalComeback, b.centerConnectors),
                    b.skipGrandFinalComeback || n(h, e, f, b, r, c)),
                d(!1),
                {
                    data: function () {
                        return q(b.init)
        ...
        , L = function (a, b) {
            if (a.hasOwnProperty(b)) {
                var c = "number"
                    , d = typeof a[b];
                if (d !== c)
                    throw new Error('Option "' + b + '" is ' + d + " instead of " + c)
            }
        }
        , M = function (a, b) {
            var c = a[b]
                ...
                , e = typeof c;
            if (e !== d)
                throw new Error("Value of " + b + " must be boolean, got " + d + ", got " + e)
        }
        , N = function (a, b, c) {
            var d = b[c];
            if (d < a)
                throw new Error("Value of " + c + " must be greater than " + a + ", got " + d)
        }
        , O = function (a) {
            return a & a - 1
        }
        , P = {
              init: function (b) {
                  ...
                  if (void 0 === c.userData && (c.userData = null),
                      !(!c.decorator || c.decorator.edit && c.decorator.render))
                  ...
                  var f = this;
                  c.el = this,
                      c.save && (c.onMatchClick || c.onMatchHover) && a.error("Match callbacks may not be passed in edit mode (in conjunction with save callback)");
                  var g = typeof c.disableToolbar
                      , j = c.hasOwnProperty("disableToolbar");
                  j && "boolean" !== g && a.error("disableToolbar must be a boolean, got " + g),
                      !c.save && j && a.error('disableToolbar can be used only if the bracket is editable, i.e. "save" callback given'),
                      j || (c.disableToolbar = void 0 === c.save);
                  var k = typeof c.disableTeamEdit
                      , l = c.hasOwnProperty("disableTeamEdit");
                  l && "boolean" !== k && a.error("disableTeamEdit must be a boolean, got " + k),
                      !c.save && l && a.error('disableTeamEdit can be used only if the bracket is editable, i.e. "save" callback given'),
                      l || (c.disableTeamEdit = !1),
                      !c.disableToolbar && c.disableTeamEdit && a.error('disableTeamEdit requires also resizing to be disabled, initialize with "disableToolbar: true"');
                  ...
                  c.init.results = J(m),
                      ...
                      L(c, "roundMargin"),
                      L(c, "matchMargin"),
                      c.hasOwnProperty("teamWidth") || (c.teamWidth = 70),
                      c.hasOwnProperty("scoreWidth") || (c.scoreWidth = 30),
                      c.hasOwnProperty("roundMargin") || (c.roundMargin = 40),
                      c.hasOwnProperty("matchMargin") || (c.matchMargin = 20),
                      N(0, c, "teamWidth"),
                      N(0, c, "scoreWidth"),
                      N(0, c, "roundMargin"),
                      N(0, c, "matchMargin"),
                      c.hasOwnProperty("centerConnectors") || (c.centerConnectors = !1),
                      M(c, "centerConnectors"),
                      c.hasOwnProperty("disableHighlight") || (c.disableHighlight = !1),
                      M(c, "disableHighlight");
                  var n = O(c.init.teams.length);
                  n !== Math.floor(n) && a.error('"teams" property must have 2^n number of team pairs, i.e. 1, 2, 4, etc. Got ' + c.init.teams.length + " team pairs."),
                      c.dir = c.dir || "lr",
                      c.init.teams = c.init.teams && 0 !== c.init.teams.length ? c.init.teams : [[null, null]],
                      c.init.teams = c.init.teams.map(function (a) {
                          return a.map(function (a) {
                              return null === a ? u.empty() : u.of(a)
                          })
                      }),
                      c.skipConsolationRound = c.skipConsolationRound || !1,
                      c.skipSecondaryFinal = c.skipSecondaryFinal || !1,
                      "lr" !== c.dir && "rl" !== c.dir && a.error('Direction must be either: "lr" or "rl"');
                  var o = K(c);
